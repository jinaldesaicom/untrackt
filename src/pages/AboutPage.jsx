...
export default function AboutPage() {
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 prose dark:prose-invert prose-headings:tracking-tight">
      ...
      <p>UnTrackt is a privacy-focused tool suite with 228+ free browser tools. Every core feature is built to run on your device with zero accounts and zero tracking.</p>
