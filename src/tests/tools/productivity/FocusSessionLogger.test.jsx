...
import FocusSessionLogger from '../../../tools/productivity/FocusSessionLogger.jsx';

const R = () => render(<HelmetProvider><FocusSessionLogger /></HelmetProvider>);

describe('FocusSessionLogger', () => {
