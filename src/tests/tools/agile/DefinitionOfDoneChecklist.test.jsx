...
import DefinitionOfDoneChecklist from '../../../tools/agile/DefinitionOfDoneChecklist.jsx';

const R = () => render(<HelmetProvider><DefinitionOfDoneChecklist /></HelmetProvider>);

describe('DefinitionOfDoneChecklist', () => {
