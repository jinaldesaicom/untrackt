...
import OpenGraphPreviewer from '../../../tools/seo/OpenGraphPreviewer.jsx';

const R = () => render(<HelmetProvider><OpenGraphPreviewer /></HelmetProvider>);

describe('OpenGraphPreviewer', () => {
