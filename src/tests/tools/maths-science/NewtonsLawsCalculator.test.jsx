...
import NewtonsLawsCalculator from '../../../tools/maths-science/NewtonsLawsCalculator.jsx';

const R = () => render(<HelmetProvider><NewtonsLawsCalculator /></HelmetProvider>);

describe('NewtonsLawsCalculator', () => {
