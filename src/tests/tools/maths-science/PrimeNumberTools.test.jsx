...
import PrimeNumberTools from '../../../tools/maths-science/PrimeNumberTools.jsx';

const R = () => render(<HelmetProvider><PrimeNumberTools /></HelmetProvider>);

describe('PrimeNumberTools', () => {
