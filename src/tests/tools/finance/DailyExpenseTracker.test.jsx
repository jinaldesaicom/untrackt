...
import DailyExpenseTracker from '../../../tools/finance/DailyExpenseTracker.jsx';

const R = () => render(<HelmetProvider><DailyExpenseTracker /></HelmetProvider>);

describe('DailyExpenseTracker', () => {
