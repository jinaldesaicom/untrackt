...
import EnergyWorkCalculator from '../../../tools/maths-science/EnergyWorkCalculator.jsx';

const R = () => render(<HelmetProvider><EnergyWorkCalculator /></HelmetProvider>);

describe('EnergyWorkCalculator', () => {
