...
import TwoMinuteTaskFilter from '../../../tools/productivity/TwoMinuteTaskFilter.jsx';

const R = () => render(<HelmetProvider><TwoMinuteTaskFilter /></HelmetProvider>);

describe('TwoMinuteTaskFilter', () => {
