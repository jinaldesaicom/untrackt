...
import ProjectScopeDefiner from '../../../tools/productivity/ProjectScopeDefiner.jsx';

const R = () => render(<HelmetProvider><ProjectScopeDefiner /></HelmetProvider>);

describe('ProjectScopeDefiner', () => {
