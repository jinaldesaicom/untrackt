...
import SprintCapacityCalculator from '../../../tools/agile/SprintCapacityCalculator.jsx';

const R = () => render(<HelmetProvider><SprintCapacityCalculator /></HelmetProvider>);

describe('SprintCapacityCalculator', () => {
