...
import BrainDumpCapture from '../../../tools/productivity/BrainDumpCapture.jsx';

const R = () => render(<HelmetProvider><BrainDumpCapture /></HelmetProvider>);

describe('BrainDumpCapture', () => {
