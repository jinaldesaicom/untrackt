...
function SDCard({ resource, isFavorite, onToggleFavorite, onVisit }) {
  ...
  const categoryLabel = systemDesignCategories.find((c) => c.id === resource.category)?.name || resource.category
