...
import ElectromagneticCalculator from '../../../tools/maths-science/ElectromagneticCalculator.jsx';

const R = () => render(<HelmetProvider><ElectromagneticCalculator /></HelmetProvider>);

describe('ElectromagneticCalculator', () => {
