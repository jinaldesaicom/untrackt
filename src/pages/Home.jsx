    ...
    <div>
      ...
      <section className="bg-white border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 md:py-20 text-center">
          ...
          <div className="mt-7 flex justify-center gap-4 sm:gap-7 text-xs sm:text-sm text-gray-500">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        <h2 className="text-xl font-bold text-gray-900 mb-6">Why UnTrackt?</h2>
