...
import GravitationalCalculator from '../../../tools/maths-science/GravitationalCalculator.jsx';

const R = () => render(<HelmetProvider><GravitationalCalculator /></HelmetProvider>);

describe('GravitationalCalculator', () => {
