...
export const productivityTools = [
  ...
  { id: 'notepad', name: 'Notepad', description: 'Distraction-free writing tool with auto-save and markdown preview', category: 'productivity', subcategory: 'writing', icon: 'FileText', path: '/tools/notepad', component: Notepad, tags: ['notepad', 'notes', 'writing', 'markdown', 'text editor'], isPopular: true, isNew: false },
  ...
  { id: 'kanban-board', name: 'Kanban Board', description: 'Visual task management board with drag-and-drop columns', category: 'productivity', subcategory: 'tasks', icon: 'LayoutGrid', path: '/tools/kanban-board', component: KanbanBoard, tags: ['kanban', 'board', 'tasks', 'project', 'agile', 'drag'], isPopular: true, isNew: false },
