...
function LearningCard({ resource, isFavorite, onToggleFavorite, onVisit }) {
  ...
  const categoryLabel = aiLearningCategories.find((c) => c.id === resource.category)?.name || resource.category
