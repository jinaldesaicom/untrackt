...
import BreadcrumbSchemaGenerator from '../../../tools/seo/BreadcrumbSchemaGenerator.jsx';

const R = () => render(<HelmetProvider><BreadcrumbSchemaGenerator /></HelmetProvider>);

describe('BreadcrumbSchemaGenerator', () => {
