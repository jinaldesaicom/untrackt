...
import DailyStandupTemplate from '../../../tools/agile/DailyStandupTemplate.jsx';

const R = () => render(<HelmetProvider><DailyStandupTemplate /></HelmetProvider>);

describe('DailyStandupTemplate', () => {
