...
import WorkingAgreementBuilder from '../../../tools/agile/WorkingAgreementBuilder.jsx';

const R = () => render(<HelmetProvider><WorkingAgreementBuilder /></HelmetProvider>);

describe('WorkingAgreementBuilder', () => {
