...
import PolynomialCalculator from '../../../tools/maths-science/PolynomialCalculator.jsx';

const R = () => render(<HelmetProvider><PolynomialCalculator /></HelmetProvider>);

describe('PolynomialCalculator', () => {
