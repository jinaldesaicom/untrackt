...
import DefinitionOfReadyChecklist from '../../../tools/agile/DefinitionOfReadyChecklist.jsx';

const R = () => render(<HelmetProvider><DefinitionOfReadyChecklist /></HelmetProvider>);

describe('DefinitionOfReadyChecklist', () => {
