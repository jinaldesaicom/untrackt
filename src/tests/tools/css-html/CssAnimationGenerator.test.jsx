...
import CssAnimationGenerator from '../../../tools/css-html/CssAnimationGenerator.jsx';

const R = () => render(<HelmetProvider><CssAnimationGenerator /></HelmetProvider>);

describe('CssAnimationGenerator', () => {
