...
import NumberTheoryCalculator from '../../../tools/maths-science/NumberTheoryCalculator.jsx';

const R = () => render(<HelmetProvider><NumberTheoryCalculator /></HelmetProvider>);

describe('NumberTheoryCalculator', () => {
