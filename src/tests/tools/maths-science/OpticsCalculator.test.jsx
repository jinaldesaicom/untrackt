...
import OpticsCalculator from '../../../tools/maths-science/OpticsCalculator.jsx';

const R = () => render(<HelmetProvider><OpticsCalculator /></HelmetProvider>);

describe('OpticsCalculator', () => {
