...
import CalculusReferenceTool from '../../../tools/maths-science/CalculusReferenceTool.jsx';

const R = () => render(<HelmetProvider><CalculusReferenceTool /></HelmetProvider>);

describe('CalculusReferenceTool', () => {
