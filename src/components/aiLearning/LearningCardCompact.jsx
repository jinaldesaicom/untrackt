...
import { categoryColorMap, levelColorMap } from './AILearningCategoryTabs.jsx'
import { aiLearningCategories } from '../../data/aiLearning.js'

function LearningCardCompact({ resource, onVisit }) {
  ...
  const categoryLabel = aiLearningCategories.find((c) => c.id === resource.category)?.shortName || resource.category
...
export default memo(LearningCardCompact)
