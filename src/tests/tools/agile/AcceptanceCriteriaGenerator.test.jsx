...
import AcceptanceCriteriaGenerator from '../../../tools/agile/AcceptanceCriteriaGenerator.jsx';

const R = () => render(<HelmetProvider><AcceptanceCriteriaGenerator /></HelmetProvider>);
