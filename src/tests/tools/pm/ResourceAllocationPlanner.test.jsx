...
import ResourceAllocationPlanner from '../../../tools/pm/ResourceAllocationPlanner.jsx';

const R = () => render(<HelmetProvider><ResourceAllocationPlanner /></HelmetProvider>);

describe('ResourceAllocationPlanner', () => {
