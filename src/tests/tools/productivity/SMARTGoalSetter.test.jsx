...
import SMARTGoalSetter from '../../../tools/productivity/SMARTGoalSetter.jsx';

const R = () => render(<HelmetProvider><SMARTGoalSetter /></HelmetProvider>);

describe('SMARTGoalSetter', () => {
