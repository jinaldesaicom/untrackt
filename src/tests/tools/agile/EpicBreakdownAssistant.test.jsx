...
import EpicBreakdownAssistant from '../../../tools/agile/EpicBreakdownAssistant.jsx';

const R = () => render(<HelmetProvider><EpicBreakdownAssistant /></HelmetProvider>);

describe('EpicBreakdownAssistant', () => {
