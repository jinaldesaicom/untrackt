...
import BinaryBooleanLogicCalculator from '../../../tools/maths-science/BinaryBooleanLogicCalculator.jsx';

const R = () => render(<HelmetProvider><BinaryBooleanLogicCalculator /></HelmetProvider>);

describe('BinaryBooleanLogicCalculator', () => {
