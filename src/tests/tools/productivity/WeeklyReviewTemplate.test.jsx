...
import WeeklyReviewTemplate from '../../../tools/productivity/WeeklyReviewTemplate.jsx';

const R = () => render(<HelmetProvider><WeeklyReviewTemplate /></HelmetProvider>);

describe('WeeklyReviewTemplate', () => {
