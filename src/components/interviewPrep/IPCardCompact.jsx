...
import { categoryColorMap, levelColorMap } from './IPCategoryTabs.jsx'
import { interviewPrepCategories } from '../../data/interviewPrep.js'

function IPCardCompact({ resource, onVisit }) {
  ...
  const categoryLabel = interviewPrepCategories.find((c) => c.id === resource.category)?.shortName || resource.category
...
export default memo(IPCardCompact)
