...
import GanttChartGenerator from '../../../tools/pm/GanttChartGenerator.jsx';

const R = () => render(<HelmetProvider><GanttChartGenerator /></HelmetProvider>);

describe('GanttChartGenerator', () => {
