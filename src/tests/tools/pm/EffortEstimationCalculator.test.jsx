...
import EffortEstimationCalculator from '../../../tools/pm/EffortEstimationCalculator.jsx';

const R = () => render(<HelmetProvider><EffortEstimationCalculator /></HelmetProvider>);

describe('EffortEstimationCalculator', () => {
